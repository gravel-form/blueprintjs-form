      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            setSubmitting(true);
            _context.next = 3;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(bluebird__WEBPACK_IMPORTED_MODULE_6__["delay"])(1000));
...
var MyFormItemTemplate = function MyFormItemTemplate(props) {
  ...
  var labelText = schema.title || dataPath[dataPath.length - 1];
  var label = schema.description ? __jsx(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_5__["Tooltip"], {
    className: "".concat(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_5__["Classes"].TOOLTIP_INDICATOR, " ").concat(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_5__["Classes"].INLINE),
  ...
  return __jsx(_blueprintjs_core__WEBPACK_IMPORTED_MODULE_5__["FormGroup"], {
    ...
    labelInfo: Object(_src_core__WEBPACK_IMPORTED_MODULE_7__["isRequired"])(props) ? '(required)' : null,
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 70,
...
//# sourceMappingURL=simple-middlewares.js.3bf00a2b55ec995bad71.hot-update.js.map